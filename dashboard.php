        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="dashboard.php?q=6">Users History</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    if(@$_GET['q']==6)
                    {
                      echo '<div class="row"><span class="title1" style="margin-left:40%;font-size:30px;color:#000;"><b>Users History</b></span><br /><br />
                      <div class="col-md-3"></div><div class="col-md-6">
                      <form class="form-horizontal title1" name="form" action="dashboard.php?q=userhistory"  method="POST">
                          <fieldset>
                              <div class="form-group">
                                  <label class="col-md-12 control-label" for="name"></label>
                                  <div class="col-md-12">
                                      <input id="name" name="email" placeholder="Enter User Email" class="form-control input-md" type="text">
                                  </div>
                              </div>
                    ...
                    if(@$_GET['q']== 'userhistory')
                    {
                      ...
                      $result = mysqli_query($con,"CALL `usersHistory`('$em')") or die('Error');

                      echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
                      <tr><td><center><b>S.N.</b></center></td><td><center><b>Name</b></center></td>
                      <td><center><b>Score</b></center></td>
                    <td><center><b>Right</b></center></td>
                      <td><center><b>Wrong</b></center></td>
                      <td><center><b>Date</b></center></td></tr>';
                      $c=1;
                      while($row = mysqli_fetch_array($result))
                      {
                          $name = $row['email'];
                          ...
                          $wrong = $row['wrong'];
                          $date = $row['date'];
                          echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$name.'</center></td>
                          <td><center>'.$score.'</center></td>
                        <td><center>'.$sahi.'</center></td>
                        <td><center>'.$wrong.'</center></td>
                        <td><center>'.$date.'</center></td></tr>';
                      }
                      $c=0;
                      echo '</table></div></div>';
                    }
